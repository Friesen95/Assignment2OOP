...
public class Teller 
{
    ...
    {
        //different scanner for use of different primative types
        ...
        while (quit == false) 
        {
            ...
            primaryMenu = false;
            hasAccount = false;//can only be accessed if primary menu is valid
            multiAccounts = false; 
            while (primaryMenu == false) 
            {
                ...
                if (choice == 1) //will create a new customer, first collect info and then save it 
                {
                    ...
                    Customer newCust = new Customer(FN, LN, age);
            ...
            while (insideMenu == true) 
            {
                if (hasAccount == true) 
                {
                    ...
                    else if (choice == 4) 
                    {
                        ...
                        //record choice and display info
